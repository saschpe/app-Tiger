...
* 'websocket' for Websocket, SockJS and STOMP (various converters)
...
See the xref:tigerTestLibrary.adoc#_complete_set_of_steps_in_validation_glue_code[Complete set of steps in validation glue code].
